...
public class Widget: INotifyPropertyChanged
{
    ...
    public ObservableCollection<WidgetFile> Files { get; }
    ...
    public Widget(string name, string folderLocation)
    {
        ...
        Files.CollectionChanged += (_, _) => OnChanged();
        _isDirty                 = true;
    }
    ...
    public void AddWidgetFiles(IEnumerable<WidgetFile> widgetFiles)
        => Files.AddRangeSorted(widgetFiles, WidgetFileComparer.Instance);
