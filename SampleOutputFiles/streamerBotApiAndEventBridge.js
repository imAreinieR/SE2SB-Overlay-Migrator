// EventAndApiBridge - bridges StreamElements Widget with StreamerBot for both events and API calls

// ApiInterceptors - Intercepts API calls to inject custom handling
...
// CachedApiInterceptor - intercepts and caches calls to a set of URLs
...
// StreamElementsApiInterceptor - intercepts calls to StreamElements API to provide dummy data for testing
registerFetchInterceptor(
...
// StreamerBotEventHandlers - bridges StreamerBot with StreamElements Widget
...
// StreamElementsSeApiFunction - intercepts calls to StreamElements API to provide dummy data for testing
const SE_API = {
  store: {
    set(keyName, object) {
      try {
